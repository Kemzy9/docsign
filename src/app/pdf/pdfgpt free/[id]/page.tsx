...
const Pdfgptfree: React.FC = () => {
  ...
  return (
    <div>
      ...
      <Head>
      <title>StudyGroup Chat-Learn Together with pdf</title>
        <meta name="description" content=" Join Study Group!Share Your pdf,chat wiht friends,Ask Question,Make Study Fun And Interactiv   " />
