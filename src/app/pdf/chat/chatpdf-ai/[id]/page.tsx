...
const ChatPdfai: React.FC = () => {
  ...
  const chatTitle = id ? `ChatInPDF allows users to hold ${id} real-time conversations within PDF files` : "Perfect for collaborative projects and interactive documents.";
  ...
  return (
    <div>
      ...
      <Head>
      <title>thechatpdf||Chat to PDF Made Easyf</title>
        <meta name="description" content="ChatInPDF allows users to hold real-time conversations within PDF files.Perfect for collaborative projects and interactive documents ." />
        <link rel="canonical" href="https://www.thechatpdf.com" />
        <meta name="keywords" content="chat to pdf, chat pdf, chatinpdf, chatpdf, free chatpdf, pdfgpt, chatpdf, thechatpdf" />
        ...
        <script type="application/ld+json">
          {JSON.stringify({
            ...
            "@type": "WebPage",
            "name": chatTitle,
            "description": id ? `ChatInPDF allows users to hold ${id} real-time conversations within PDF files` : "Perfect for collaborative projects and interactive documents.",
