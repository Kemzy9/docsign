            ...
            <div className="container mx-auto py-16 dark:text-white">
                <div className="text-center">
                    ...
                    <div className="max-w-2xl md:max-w-4xl mx-auto dark:text-black my-4 leading-6 tracking-wide">
                        <p>
                            Our AI tool service goes through a thorough analysis that&apos;s super detailed. It&apos;s used by students, lawyers, and universities all around the globe in their everyday tasks. 
                            We&apos;ve made sure it&apos;s completely spam-free and encrypted, so your PDFs and data are safe.
                        </p>
                    </div>
                </div>
