...
const Follow: React.FC = () => {
    const [followers, setFollowers] = useState<number>(12);
            ...
            <div className="max-w-sm mx-auto bg-white dark:bg-gray-900 rounded-lg overflow-hidden shadow-lg">
                ...
                <div className="px-4 py-4">
                    <div className="flex gap-2 items-center text-gray-800 dark:text-gray-300 mb-4">
                        ...
                        <span><strong className="text-black dark:text-white">{followers}</strong> Followers you know</span>
                    </div>
                    <div className="flex">
                        <div className="flex justify-end mr-2">
                            <Image className="border-2 border-white dark:border-gray-800 rounded-full h-10 w-10 -mr-2"
